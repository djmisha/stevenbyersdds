 ...
 * Use like: background-image: url('+silvr_data.templateDirectoryUri+'/images/dd-meet-our-team.jpg)
 */
function silvr_data_array(){
	$theme = wp_get_theme();
	$data = array(
...
function bodyClass2( $classes ) {
	...
	$classes[]	= ( this_is('gallery') ) ? 'rmgallery' : 'not-gallery';
