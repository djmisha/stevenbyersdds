...
function __themecss()
{
    // wp_register_style('moby', TMPL_DIR_URI . '/js/libs/moby/moby.min.css');
    ...
    // wp_register_style('beerslider', TMPL_DIR_URI . '/js/libs/beerslider/BeerSlider.css');
    ...
    // wp_register_style('silvr-theme', get_stylesheet_uri(), array('splide' , 'fancybox' , 'fontawesome'), '1');
